  ...
  return (
    <main>
      ...
      <Section id="brokers" title="Brokers" subtitle="Need extra trucks? We partner with vetted owner‑operators.">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="card p-6">
            <h3 className="font-semibold text-lg">Broker Request</h3>
            <p className="text-slate-300 text-sm mt-1">Tell us about your job and how many trucks you need.</p>
            <div className="mt-4"><BrokerForm /></div>
          </div>
          <div className="card p-6">
            <h3 className="font-semibold text-lg">What to Expect</h3>
            <ul className="mt-3 space-y-2 text-sm text-slate-300 list-disc pl-5">
              <li>WSIB & insurance verified</li>
              <li>Safety-first orientation</li>
              <li>Experienced tri-axle drivers</li>
              <li>Consistent work with on-time pay</li>
            </ul>
          </div>
        </div>
      </Section>
      ...
      <Section id="contact" title="Contact">
        <div className="card p-6 grid md:grid-cols-3 gap-6">
          <div><div className="font-semibold">Dispatch</div><div className="text-slate-300 text-sm">+1 (647) 968‑4422</div></div>
          <div><div className="font-semibold">Email</div><div className="text-slate-300 text-sm">sgntransport94@gmail.com</div></div>
          <div><div className="font-semibold">Address</div><div className="text-slate-300 text-sm">Brampton, Ontario</div></div>
        </div>
      </Section>
