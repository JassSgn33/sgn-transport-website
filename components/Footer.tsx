    ...
    <footer className="border-t border-slate-800 py-10">
      <div className="container grid md:grid-cols-3 gap-8 items-center">
        ...
        <ul className="text-sm text-slate-300 space-y-1">
          <li>Dispatch: <a href="tel:+16479684422" className="underline">+1 (647) 968‑4422</a></li>
          <li>Email: <a href="mailto:sgntransport94@gmail.com" className="underline">sgntransport94@gmail.com</a></li>
          <li>Instagram: <a href="https://instagram.com/sgntransportinc" target="_blank" rel="noreferrer" className="underline">@sgntransportinc</a></li>
